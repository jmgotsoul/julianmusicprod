(function() {
  ...
  var desktop_nav, height_line, init_classic_menu, init_classic_menu_resize, init_count_number, init_navigation_scroll, init_progress_bar, init_skrollr, init_wow, mobileTest, mobile_nav, init_carousel;
  ...
  /*
    Owl Carousel currently has the following defect: https://github.com/OwlCarousel2/OwlCarousel2/issues/1911
    Due to this defect I have set autoplayHoverPause to false. Once this defect is fixed I wil set it to true.
   */
  init_carousel = function() {
    $('.tvfilm_carousel').owlCarousel({
      items: 3,
      loop: true,
      autoplay: true,
